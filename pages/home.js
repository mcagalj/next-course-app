                    ...
                    <div className="mt-12 sm:grid sm:grid-cols-2 sm:gap-4">
                        <div className="h-96 sm:border hover:cursor-pointer first:mt-0">
                            ...
                            <div className="flex px-10 items-center relative mt-8 sm:hidden">
                                <p className="uppercase text-xl font-semibold text-hci-lila">
                                    New design system
                                </p>
                        ...
                        <div className="h-96 sm:border hover:cursor-pointer my-12 sm:mt-0">
                            <div className="h-4/5 bg-gray-100 relative">
                                <Image
                            ...
                            <div className="h-1/5 bg-gray-300 flex items-center justify-center relative hidden sm:flex">
                                <p className="capitalize font-roboto-condensed text-xl text-hci-lila">
                                    Design from scratch
                                </p>
                                <div className="absolute right-4 h-full flex items-center">
                        ...
                        <div className="h-96 sm:border hover:cursor-pointer">
                            <div className="h-4/5 bg-gray-100 relative">
                                <Image
                                    src={'/book-cover.jpg'}
                                    layout="fill"
